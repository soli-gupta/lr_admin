...
function BookingList() {
    ...
    const { data, error } = useSWR(`${Url}admin/get-all-orders?page=${page}&orderType=extended-warranty`, fetcher);
    ...
    const viewOrderDetails = (_id) => {
        router.push(`/admin/extended-warranty/${_id}`);
    }
    ...
    return (
        <>
            <AdminHead pageTitle={`Extended Warranty`} />
            <Layout>
                <Breadcrumb title="Extended Warranty" />
