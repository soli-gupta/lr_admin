                            ...
                            <div className="detail-row box">
                                ...
                                <table>
                                    <tr>
                                        <th>Car Name</th>
                                        <td>
                                            <span>{data.order.order_car_name}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Brand Name</th>
                            ...
                            <div className="detail-row box">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span>
                                                {data.order.order_status === 1 ? "Booked" : data.order.order_status === 2 ? "Completed" : data.order.order_status === 3 ? "Cancelled" : data.order.order_status === 4 ? "Pending" : ''}
                                                {/* <br /> */}
