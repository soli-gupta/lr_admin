...
function Index() {
    ...
    const { data, error } = useSWR(`${process.env.NEXT_PUBLIC_URL}admin/get-all-leads?page=${page}&lead_type=Loan`, fetcher);
    ...
    return (
        <>
            <AdminHead pageTitle={`Loans Leads`} />
            <Layout>
                <Breadcrumb title="Loans Leads" />
