...
export default function Index() {
    ...
    return (
        <>
            <Head>
                <title>LR | Service Category  </title>
            ...
            <Layout>
                <Breadcrumb title="Service Category" addBtn="Add Service Category" url="/admin/service/service-category/add-service-category" />
                <div className="main-data">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            {serviceCategory != '' && serviceCategory.length > 0 && serviceCategory?.map((service, i) => {
                                const count = 0
                                return (
                                    <tr key={i}>
                                        <td>
                                        ...
                                        <td>
                                            <div className="table-buttons">
                                                <Link href={`/admin/service/service-category/add-service-category?id=${service._id}`}><button className='duplicate'>Edit</button>
                                                </Link>
