...
export default function Index() {
    ...
    const { data, error } = useSWR(`${process.env.NEXT_PUBLIC_URL}admin/admin-service-list?page=${page}`, fetcher);
    ...
    return (
        <>
            ...
            <Layout>
                <Breadcrumb title="Service" addBtn="Add Service" url="/admin/service/add-service" />
                            ...
                            {data && data.data?.map((services, i) => {
                                ...
                                return (
                                    <tr key={i}>
                                        ...
                                        {/* <td>
                                            {services.brand_id && services.brand_id.brand_name}
                                        </td>
                                        <td>
                                            {services.model_id && services.model_id.model_name}
                                        </td>
                                        <td>
                                            {services.variant_id && services.variant_id.variant_name}
                                        </td> */}
                                        <td>
                                            {services.brand_name}
                                        </td>
                                        ...
                                        <td>
                                            <div className="table-buttons">
                                                <Link href={`/admin/service/add-service?id=${services._id}`}>  <button className='duplicate'>Edit</button>
                                                </Link>
                                            </div>
                                        </td>
                                    </tr>
