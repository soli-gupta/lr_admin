...
export default function Index() {
    ...
    // console.log(fetchAllProductsForLink.data)
    ...
    const saveCardetails = async (e) => {
        ...
        formData.append('booking_amount', e.target.booking_amount.value);

        setTinyLoader(true);

        await axios.post(`${process.env.NEXT_PUBLIC_URL}admin/create-product`, formData, {
            headers: {
                token: localStorage.getItem('lr-admin-token')
            }
        }).then((response) => {
            if (response.data.status === 1) {
                ...
                setTinyLoader(false);
                alert(`${response.data.products.name} addedd successfully!`);
    ...
    let getProdOpt = [];
    if (fetchAllProductsForLink.data !== undefined && fetchAllProductsForLink.data.products !== undefined) {
        // console.log('fetchAllProductsForLink.data.products  : ', fetchAllProductsForLink.data.products);
    ...
    return (
        <>
            <AdminHead pageTitle={`Add Car`} />
            <Layout>

                <Breadcrumb title="Luxury Ride| Add Car" />
                <div className="main-data">
                    <div className="tabers">
                        <div className="wrapper">
                            <ul>
                                {/* onClick={carDetailBtnClick}  */}
                                <li className={carDetail === true ? 'edit activeTab' : ''} value="1" id="car-detail-btn">
                                    Car Details
                                </li>
                                {/* onClick={carSummeryBtnClick} */}
                                <li className={carSummery === true ? 'edit activeTab' : ''} id="car-summery-btn" value="2">
                                    Car Summary
                                    {/* 63ff8dbf9b291064b4745218 */}
                                </li>
                                {/*  */}
                                <li className={carSeo === true ? 'edit activeTab' : ''} id="car-seo-btn" value="3">
                                    SEO
                                </li>
                                {/* <li className={carSpecification === true ? 'edit activeTab' : ''}  >
                                    Specification
                                </li> */}
                            ...
                            <div className="wrapper">
                                <form method="POST" onSubmit={saveCardetails} id="car-detail-form">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-div">
                                            <select className="floating-select" id="model_id" name="model_id" onChange={(e) => fetchVariantsByModel(e.target.value)}>
                                                <option value=""></option>
                                                {
                                                    fetchModelsName.data && fetchModelsName.data.brand_model.map((model) => {
                                                        return (
                                        ...
                                        <div className="form-div">
                                            <select className="floating-select" id="variant_id" onChange={createCustomSlug} name="variant_id" >
                                                <option value=""></option>
                                                {
                                                    variantsByModel.data && variantsByModel.data.model_variant.map((model) => {
                                                        return (
                                                            <option value={`${model._id}`} key={model._id}>{model.name}</option>
                                                        )
                                                    })
                                    ...
                                    <div className="form-row two-col">
                                        <div className="form-div">
                                            <input id="name" name="name" type="text" onChange={manageEventHandler} placeholder=" " onKeyUp={(e) => createSlug(e.target.value, 'slug')} onLoad={() => createSlug(e.target.value, 'slug')} />
                                        ...
                                        <div className="form-div">
                                            ...
                                            <input id="slug" name="slug" onChange={manageEventHandler} type="text" placeholder=" " />
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-div">
                                            <input id="registration_state" name="registration_state" onChange={manageEventHandler} type="text" placeholder=" " />
                                            <label htmlFor="Registration State">Registration State</label>
                                            <small id="registrationState" className="error"></small>
                                        </div>

                                        <div className="form-div">
                                            <input id="kms_driven" name="kms_driven" type="text" onChange={manageEventHandler} placeholder=" " />
                                    ...
                                    <div className="form-row">
                                        <div className="form-div">
                                            <input id="product_ownership" name="product_ownership" type="text" onChange={manageEventHandler} placeholder=" " />
                                        ...
                                        <div className="form-div">
                                            <select className="floating-select" onChange={manageEventHandler} id="fuel_type" name="fuel_type">
                                                <option value=""></option>
                                                {
                                                    fetchFuelType.data && fetchFuelType.data.fuel_type.map((fuel) => {
                                                        return (
                                                            <option value={`${fuel._id}`} key={fuel._id}>{fuel.name}</option>
                                                        )
                                                    })
                                                }
                                            </select>
                                        ...
                                        <div className="form-div">
                                            <input id="price" name="price" type="text" onChange={manageEventHandler} placeholder=" " />
                                    ...
                                    <div className="form-row two-col">
                                        ...
                                        <div className="form-div">
                                            <input id="color" name="color" type="text" onChange={manageEventHandler} placeholder=" " />
                                    ...
                                    <div className="form-row two-col">
                                        ...
                                        {/* {console.log(data.products.linked_from)} */}
                                        {/* <Select
                                        ...
                                        <div className="form-div">
                                            <input id="booking_amount" name="booking_amount" type="text" onChange={manageEventHandler} placeholder=" " />
                                    ...
                                    <div className='custom-check'>
                                        <div className='form-div'>
                                            <input type="checkbox" name="product_banner" id="html" defaultValue="1" />
                        ...
                        <div className="form-style">
                            <div className="wrapper">
                                <form method="POST" onSubmit={updateCarSummery} id="car-summery-form">
                                    ...
                                    <div className="form-row">
                                        <div className="form-div">
                                            <input id="manufacturing_year" name="manufacturing_year" type="text" placeholder=" " onChange={manageEventHandler} />
                                        ...
                                        <div className="form-div">
                                            <input id="engine_cc" name="engine_cc" type="text" placeholder=" " onChange={manageEventHandler} />
                                        ...
                                        <div className="form-div">
                                            <select className="floating-select" id="body_type" name="body_type" onChange={manageEventHandler} >
                                                <option value=""></option>
                                                {
                                                    fetchBodyType.data && fetchBodyType.data.body_type.map((body) => {
                                                        return (
                                                            <option value={`${body._id}`} key={body._id}>{body.body_name}</option>
                                                        )
                                                    })
                                                }
                                            </select>
                                    ...
                                    <div className="form-row">
                                        <div className="form-div">
                                            <input id="insurance_type" name="insurance_type" type="text" placeholder=" " onChange={manageEventHandler} />
                                            <label htmlFor="Insurance Type">Insurance Type</label>
                                        </div>

                                        <div className="form-div">
                                            <input id="insurance_valid" name="insurance_valid" type="text" placeholder=" " onChange={manageEventHandler} />
                                            ...
                                            <select className="floating-select" id="product_location" name="product_location" onChange={manageEventHandler} >
                                                <option value=""></option>
                                                {
                                                    fetchExperienceCenter.data && fetchExperienceCenter.data.experience_center.map((showroom) => {
                                                        return (
                                                            <option value={`${showroom._id}`} key={showroom._id}>{`${showroom.name} (${showroom.city})`}</option>
                                                        )
                                                    })
                                                }
                                            </select>
                                    ...
                                    <div className="form-row">
                                        <div className="form-div">
                                            <input id="registration_number" name="registration_number" type="text" placeholder=" " onChange={manageEventHandler} />
                        ...
                        <div className="form-style">
                            <div className="wrapper">
                                ...
                                <form method="POST" onSubmit={updateCarSeoDetails} id="car-seo-details-form">
                                    <div className="form-row">
                                        <div className="form-div">
                                            <input id="page_title" name="page_title" onChange={manageEventHandler} type="text" placeholder=" " />
                                        ...
                                        <div className="form-div">
                                            <input id="meta_keywords" name="meta_keywords" onChange={manageEventHandler} type="text" placeholder=" " />
                                        ...
                                        <div className="form-div">
                                            <input id="meta_other" name="meta_other" onChange={manageEventHandler} type="text" placeholder=" " />
                                    ...
                                    <div className="form-row one-col">
                                        <div className="form-div">
                                            <textarea placeholder=" " name="meta_description" onChange={manageEventHandler} id="meta_description"></textarea>
                            ...
                            <div className="wrapper">
                                ...
                                <form method="POST" onSubmit={updateCarFeatureSpecification} id="car-specification-details-form">
                                    ...
                                    <div className="form-row" >
...

                                        {
                                            fetchFeatureCategory.data && fetchFeatureCategory.data.categories.map((category) => {
                                                let getFetchdata = [];
                                                const fetchSpecData = axios.get(`${process.env.NEXT_PUBLIC_URL}admin/fetch-feature-by-category?id=${category._id}`, {
                                                    headers: {
                                                        token: localStorage.getItem('lr-admin-token')
                                                    }
                                                }).then((response) => {
                                                ...
                                                return (
                                                    <>
                                                        ...
                                                        </div>
                                                        {
                                                            ...
                                                            fetchSpecData.data && fetchSpecData.data.features.map((feature) => {
                                                                return (
                                                                    <>
                                    ...
                                    {/* 
                                    {
                                        featureSpecification.data && featureSpecification.data.features.map((feature) => {
                                            return (
                                                <div className="form-row" key={feature._id} >
                                                    <div className="form-div">
                                                        <input id="" name="" type="text" readOnly value={feature.name} placeholder=" " />
                                                        <label htmlFor="Specification Value">{feature.name}</label>
                                                        <small id="specificationValue" className="error"></small>
