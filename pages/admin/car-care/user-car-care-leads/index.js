...
export default function Index() {
    ...
    const { data, error } = useSWR(`${process.env.NEXT_PUBLIC_URL}admin/user-car-care-list?page=${page}`, fetcher);
    ...
    return (
        <>
            <Head>
                <title>LR | Car Care Data</title>
                <meta name="description" content="Generated by create next app" />
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <link rel="icon" href="../img/favicon.ico" />
            </Head>
            <Layout>
                <Breadcrumb title="Car Care Data" />
                                        ...
                                        <tr key={i}>
                                            ...
                                            <td>
                                                <div className="table-buttons">
                                                    <Link href={`/admin/car-care/user-car-care-leads/${data._id}`}>
