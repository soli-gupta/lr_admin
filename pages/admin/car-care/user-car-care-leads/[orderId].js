import { convertTimeStamp } from "@/components/Helper";
...
function Index() {
    ...
    const { data, error } = useSWR(`${Url}admin/edit-car-care-detail/${orderId}`, fetcher);


    const updateUserCarCareByAdmin = async (e) => {
        e.preventDefault();

        const formData = new FormData(document.getElementById('carCareAdminForm'));
        for (const pair of formData.entries()) {
            console.log(`${pair[0]}, ${pair[1]}`);
        }
        await axios.post(`${Url}admin/update-car-care-detail`, formData, {
            headers: {
                    ...
                    <div className="detail-list" >
                        ...
                        <div className="detail-main">
                            ...
                            <div className="detail-row box">
                                ...
                                <form method="POST" onSubmit={updateUserCarCareByAdmin} id="carCareAdminForm">
                                    <table>
                                        <tr>
                                            <th>Status</th>
