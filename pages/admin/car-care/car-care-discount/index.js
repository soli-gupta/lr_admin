...
export default function Index() {
    ...
    const serviceList = async () => {
        await axios.get(`${process.env.NEXT_PUBLIC_URL}admin/car-care-discount-list`, {
            headers: {
    ...
    const updateStatus = async (status, id) => {
        ...
        await axios.get(`${process.env.NEXT_PUBLIC_URL}admin/active-deactive-car-care-discount?id=${id}&status=${status}`, {
            headers: {
                'token': typeof window !== "undefined" ? localStorage.getItem("lr-admin-token") : false,
            }
        }).then(function (res) {
    ...
    return (
        <>
            <Head>
                <title>LR | Car Care Discount</title>
            ...
            <Layout>
                <Breadcrumb title="Car Care Discount" addBtn="Add Car Care Discount" url="/admin/car-care/car-care-discount/add-car-care-discount" />
                                ...
                                return (
                                    <>
                                        ...
                                        <tr key={i}>
                                            ...
                                            <td>
                                                {services.car_care_discount_price} {services.discount_type === '1' ? '₹' : '%'}
                                            </td>
                                            ...
                                            <td>
                                                <div className="table-buttons">
                                                    <Link href={`/admin/car-care/car-care-discount/add-car-care-discount?id=${services._id}`}>  <button className='duplicate'>Edit</button>
                                                    </Link>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        {/* {serviceCat && serviceCat.map((subCat, i) => {
                                            return (
                                                <tr key={i}>
                                                    ...
                                                    <td>
                                                        {subCat.car_care_category && subCat.service_category.service_category_name}
                                                    </td>
                                                    <td>
                                                        {subCat.service_name}
                                                    </td>
