...
export default function Index() {
    ...
    return (
        <>
            <Head>
                <title>LR | Car Care Category  </title>
            ...
            <Layout>
                <Breadcrumb title="Car Care Categories" addBtn="Add Car Care Category" url="/admin/car-care/car-care-category/add-car-care-category" />
                <div className="main-data">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            {carCareCategory != '' && carCareCategory.length > 0 && carCareCategory?.map((service, i) => {
                                const count = 0
                                return (
                                    <tr key={i}>
                                        <td>
                                        ...
                                        <td>
                                            <div className="table-buttons">
                                                <Link href={`/admin/car-care/car-care-category/add-car-care-category?id=${service._id}`}><button className='duplicate'>Edit</button>
                                                </Link>
